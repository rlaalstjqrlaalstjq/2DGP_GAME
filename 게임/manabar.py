...
class Manabar:
    ...
    def draw(Manabar):
        ...
        Manabar.image.clip_draw(0, 20, 400, 70, 400, 40)
        if (Manabar.bar_num*19) < 380:
            Manabar.image.clip_draw(0, 0, int(Manabar.bar_num*35), 20, 400, 40)
        ...
        if Manabar.bar_num <10:
            Manabar.font.draw(150, 40, '%3.2i' % Manabar.bar_num, (0, 200, 0))
        else:
            Manabar.bar_num = 10
            Manabar.font.draw(150, 40, '%3.2i' % Manabar.bar_num, (0, 200, 0))
