...
from stage_night import Stage_Night
...
def enter():
    ...
    global stage_night
    stage_night = Stage_Night()
    game_world.add_object(stage_night, 0)
    ...
    global monster1
    monster1 = [Monster1() for i in range(25)]
    game_world.add_objects(monster1, 1)
    global monster2
    monster2 = [Monster2() for i in range(25)]
    game_world.add_objects(monster2, 1)
    global monster3
    monster3 = [Monster3() for i in range(25)]
    game_world.add_objects(monster3, 1)
    global monster4
    monster4 = [Monster4() for i in range(25)]
...
def handle_events():
    ...
    for event in events:
        if event.type == SDL_QUIT:
            ...
            game_framework.change_state(title_stage)
